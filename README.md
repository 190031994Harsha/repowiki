...
| Evaluation on 12 repos (one challenging), comparison table | [`evals/parallel_runner.py`](evals/parallel_runner.py) over 12 public repos (10 Python + Go + TS; fastapi = the challenging metaprogramming case) → `evals/report.md` |
